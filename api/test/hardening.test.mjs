...
// ---------------------------------------------------------------------------------------------
// H34 — A first-match scan over an ORDERED catalogue made one of its entries unreachable, and the
...
test('H34: a first-match fact catalogue never hides a specific entry behind a general one', async () => {
...
// ---------------------------------------------------------------------------------------------
// H35 — A stored setting that production READS and nothing WRITES is a constant wearing a
...
test('H35: every per-owner settings column production reads has a writer that can set it', () => {
  ...
  // The KNOWN set, pinned. Same reasoning as H34: asserting "none" would be red on arrival for a
