...
**§4.11 tally — 9 rows:** BUILT **6** · PARTIAL **1** · ABSENT **0** · DELIBERATE **2**. *(RECOUNTED from the rows 2026-09-02 — the stated line had gone stale as rows were re-verdicted, so this section was UNDER-claiming. `H:coverage-tally-matches-rows` (`app/test/prototypeCoverage.test.mjs`).)*
...
> # **173 of 181 prototype elements present (95.6%)**
>
> | | Count | Share of 181 |
> |---|---:|---:|
> | **BUILT** | **173** | **95.6%** |
